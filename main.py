...
def open(x):
    """ rel_path = "dir" + x + ".lnk" """
    rel_path = os.path.join("dir", str(x) + ".lnk")
...
your_games_label = tk.Label(root, text="Your Games",
                            font=("sans serif", 28), fg="#1e81b0", justify="left")

your_games_label.pack(pady=5)

for i in game:
    tk.Button(root, width=20, height=10, font=("sans serif", 18), text=i.replace(".exe", ""),
